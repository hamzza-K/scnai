...
from scnai.services.cosmos import (
    build_cosmos_container,
    build_embeddings_cache_container,
)
...
async def lifespan(app: FastAPI):
    ...
    app.state.cosmos_embeddings_container = build_embeddings_cache_container(
        settings
    )
    yield
